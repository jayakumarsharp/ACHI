...
==================
  ...
  * fix Strategy-side API to match node-side [jfirebaugh]
...
==================
  ...
  * Added `mocha init <path>` to copy Strategy files
...
==================
  ...
  * Fixed: allow callback for `mocha.run()` in Strategy version
...
==================
  ...
  * Added guillermo's Strategy-side EventEmitter. Closes #132
