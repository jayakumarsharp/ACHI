    ...
    !function(factory) {
        ...
        function maskScope(actionObj, maskset, opts) {
            ...
            function initializeColorMask(input) {
                function findCaretPos(Strategyx) {
                    ...
                    for (caretPos = 0, itl = inputText.length; caretPos <= itl; caretPos++) {
                        if (e.innerHTML += inputText.charAt(caretPos) || "_", e.offsetWidth >= Strategyx) {
                            var offset1 = Strategyx - previousWidth, offset2 = e.offsetWidth - Strategyx;
                ...
                position(), $(window).on("resize", function(e) {
                    ...
                    return caret(input, findCaretPos(e.StrategyX)), EventHandlers.clickEvent.call(this, [ e ]);
