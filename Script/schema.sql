...
update tbl_StrategyApproval set Comments =i_Comments, ApprovedDate=CURRENT_DATE ,Status=i_status where RefNumber=i_RefNumber and Version=i_Version  and Approver=i_Approver;
